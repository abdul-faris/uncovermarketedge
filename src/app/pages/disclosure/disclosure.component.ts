    ...
    <main class="legal-page">
      <div class="legal-container fade-up">
        ...
        <div class="legal-content">
          <h3>1. Regulatory Status</h3>
          <p>UncoverMarketEdge Research is a SEBI-registered Research Analyst firm. As part of our regulatory obligations, we maintain strict transparency regarding any conflicts of interest.</p>

          <h3>2. Analyst Holdings</h3>
          <p>The Research Analysts authoring our reports or providing recommendations may or may not have a personal holding or interest in the companies or securities discussed. Any specific conflict of interest or holding in the recommended stock is explicitly disclosed at the time of the recommendation.</p>

          <h3>3. Remuneration</h3>
          <p>UncoverMarketEdge Research does not receive any compensation or remuneration from the companies whose securities we recommend. Our primary source of revenue is subscription fees from our clients.</p>
        </div>
      </div>
    </main>
    <app-footer />
