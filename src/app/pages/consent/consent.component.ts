      ...
      <section class="consent-hero">
        ...
        <div class="ch-content">
          ...
          <p class="ch-sub fade-up delay-2">
            Nexus Research Registration No.: INH000014553
          </p>
        </div>
      </section>
            ...
            <form [formGroup]="form" (ngSubmit)="onSubmit()" novalidate class="consent-form">
              ...
              <div class="form-group terms-section">
                ...
                <div class="terms-box">
                  ...
                  <p>i. Research Analyst: Nexus Research a SEBI Registered Research Analyst, holding Registration No. <strong>INH000014553</strong>, with its registered office located at Kalakota Heights, Plot no 9, 4th Floor, Sarjapur-Marathahalli Rd, Jakkasandra, 1st Block Koramangala, Bengaluru, Karnataka-560034. hereinafter referred to as the "Research Analyst" or "RA";</p>
